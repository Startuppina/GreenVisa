...
const { authenticateJWT, authenticateAdmin } = require('../middlewares/auth.middleware');
const { emailCheck, passwordCheck, phoneCheck, vatCheck, cfCheck } = require('../utils/validators');
