    ...
    return (
        <div className="w-full h-[70vh] relative m-0">
            ...
            <div className="w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-5 text-center z-20">
                ...
                <button className="mt-7 font-arial font-semibold text-xl text-white w-[70%] md:text-2xl md:w-[50%] lg:text-2xl lg:w-[30%] p-3 bg-[#2d7044] rounded-[15px] transition-colors duration-300 ease-in-out hover:bg-white hover:text-[#2d7044] border-2 border-transparent hover:border-[#2d7044]">
