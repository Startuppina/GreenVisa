...
function Carrello() {
    ...
    const [isEmpty, setIsEmpty] = useState(true);  // Inizialmente impostato su true
                        ...
                        <React.Fragment key={product.product_id}>
                            ...
                            <div className="w-[250px] h-[200px] overflow-hidden">
                                ...
                                <div className="w-full md:w-[60%] p-8 flex flex-col gap-5 text-arial text-xl text-left">
                                    ...
                                    <div onClick={() => handleRemoveProduct(product.product_id)} className="underline text-[#2d7044] hover:text-red-500 cursor-pointer z-10 transition-colors duration-300 ease-in-out">Rimuovi articolo</div>
                                </div>
                            </div>
