...
function Footer({ styleProp }) {
    return (
        <div className="p-5 flex flex-col md:flex-row justify-between bg-[#e6e6e6]" style={styleProp}>
            <div className="w-full items-center md:items-start justify-center flex flex-col">
            ...
            <div className="w-full items-center justify-center md:justify-end  flex flex-row flex-wrap gap-5 pt-2">
