...
function SolarForm() {
    const [installedArea, setInstalledArea] = useState("");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`http://localhost:8080/api/buildings/${id}/upload/solar`, formData, {
                headers: {
    ...
    return (
        <div className="w-full mx-2">
            ...
            <div className="w-[98.5%] mx-auto my-10 md:m-4 rounded-2xl font-arial text-xl px-10 py-6 border border-gray-300 shadow-xl bg-[#f6f3f3] mb-4">
                <h2 className="text-2xl font-bold text-center mb-6">Inserisci un nuovo impianto solare termico</h2>
