  ...
  return (
    <>
      ...
      <div className='mt-12 w-full h-auto flex flex-col items-center justify-center'>
        ...
        <button className="mt-7 mb-10 font-arial font-semibold text-xl text-white w-[70%] md:text-2xl md:w-[50%] lg:text-2xl lg:w-[30%] p-3 bg-[#2d7044] rounded-[15px] border-2 border-transparent hover:border-[#2d7044] transition-colors duration-300 ease-in-out hover:bg-white hover:text-[#2d7044]">
