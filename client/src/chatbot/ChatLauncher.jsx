  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-full
                 bg-[#2d7044] text-white shadow-lg hover:bg-[#245a37] transition-all hover:shadow-xl
                 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2d7044] focus-visible:ring-offset-2"
    >
